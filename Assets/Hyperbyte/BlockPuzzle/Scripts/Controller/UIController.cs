...
namespace Hyperbyte
{
    ...
    public class UIController : Singleton<UIController>
    {
        ...
        public GameObject showHintWithAdScreen;
        public GameObject showHintWithoutAdScreen;
        public GameObject CalculatorPurchaseConfirm;
        ...
        void ProcessBackButton(string currentScreen)
        {
            switch (currentScreen)
            {
                ...
                case "ShowHintWithoutAd":
                    showHintWithoutAdScreen.Deactivate();
                    break;

                case "CalculatorPurchaseConfirm":
                    CalculatorPurchaseConfirm.Deactivate();
                    break;
            }
        }
