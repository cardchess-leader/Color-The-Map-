...
namespace DigitalRubyShared
{
    ...
    public class FingersScript : MonoBehaviour
    {
        ...
        [Range(0.1f, 10.0f)]
        public float MouseDistanceInUnitsForScaleAndRotate = 1.0f;

        /// <summary>Mouse wheel delta multiplier.</summary>
        [Tooltip("Mouse wheel delta multiplier.")]
        [Range(0.0001f, 1.0f)]
        public float MouseWheelDeltaMultiplier = 0.01f;
        ...
        {
            GestureRecognizer.ClearConsumedTouches();
